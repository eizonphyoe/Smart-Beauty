...
public class BoyArmAdapter extends BaseAdapter {
    private List<ImageItem> imageList;
    private Context mContext;

    public BoyArmAdapter(Context context, List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getbArm(),0,imageList.get(position).getbArm().length);
