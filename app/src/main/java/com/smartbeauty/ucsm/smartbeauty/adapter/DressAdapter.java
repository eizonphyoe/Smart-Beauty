...
public class DressAdapter extends BaseAdapter {
    ...
    public DressAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm = BitmapFactory.decodeByteArray(imageList.get(position).getFashion(), 0, imageList.get(position).getFashion().length);
