...
public class BoyLegAdapter extends BaseAdapter {
    private List<ImageItem> imageList;
    private Context mContext;

    public BoyLegAdapter(Context context, List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getLeg(),0,imageList.get(position).getLeg().length);
