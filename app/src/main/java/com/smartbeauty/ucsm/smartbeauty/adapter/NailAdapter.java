...
public class NailAdapter extends BaseAdapter {
    private Context mContext;
    private List<ImageItem> imageList;

    public NailAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm = BitmapFactory.decodeByteArray(imageList.get(position).getNail(), 0, imageList.get(position).getNail().length);
