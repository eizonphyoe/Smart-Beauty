...
public class TallAdapter extends BaseAdapter {
    ...
    public TallAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getTall(),0,imageList.get(position).getTall().length);
