...
public class BoyChestAdapter extends BaseAdapter {
    private List<ImageItem> imageList;
    private Context mContext;

    public BoyChestAdapter(Context context, java.util.List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getChest(),0,imageList.get(position).getChest().length);
