...
public class BellyAdapter extends BaseAdapter {
    private Context mContext;
    private List<ImageItem> imageList;

    public BellyAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getBelly(),0,imageList.get(position).getBelly().length);
