...
public class ArmAdapter extends BaseAdapter {
    ...
    public ArmAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getArm(),0,imageList.get(position).getArm().length);
