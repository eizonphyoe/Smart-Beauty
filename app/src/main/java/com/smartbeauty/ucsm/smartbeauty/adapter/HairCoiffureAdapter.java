...
public class HairCoiffureAdapter extends BaseAdapter {
    private Context mContext;
    private List<ImageItem> imageList;
    // private ImageItem imageItem;

    public HairCoiffureAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getHairCoiffure(),0,imageList.get(position).getHairCoiffure().length);
