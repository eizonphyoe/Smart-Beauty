...
public class LipAdapter extends BaseAdapter {
    ...
    public LipAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getLip(),0,imageList.get(position).getLip().length);
