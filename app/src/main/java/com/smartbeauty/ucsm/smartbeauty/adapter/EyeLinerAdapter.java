...
public class EyeLinerAdapter extends BaseAdapter{
    private Context mContext;
    private List<ImageItem> imageList;
    private ImageItem imageItem;

    public EyeLinerAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getEye(),0,imageList.get(position).getEye().length);
