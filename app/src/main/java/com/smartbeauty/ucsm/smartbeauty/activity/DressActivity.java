...
import com.smartbeauty.ucsm.smartbeauty.adapter.DressAdapter;
...
public class DressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgitem= dbHandler.getFashion();
       dressAdapter=new DressAdapter(this,imgitem);
        gridView.setAdapter(dressAdapter);

        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ImageItem item = (ImageItem) parent.getItemAtPosition(position);

                Intent intent = new Intent(DressActivity.this, PhotoDetailActivity.class);
                intent.putExtra("image", item.getFashion());
