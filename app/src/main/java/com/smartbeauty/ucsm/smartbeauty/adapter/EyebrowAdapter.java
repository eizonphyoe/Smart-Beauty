...
public class EyebrowAdapter extends BaseAdapter {
    private Context mContext;
    private List<ImageItem> imageList;
    private ImageItem imageItem;

    public EyebrowAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getEyeBorrow(),0,imageList.get(position).getEyeBorrow().length);
