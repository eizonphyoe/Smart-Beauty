...
public class CalfAdapter extends BaseAdapter {
    ...
    public CalfAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getCalf(),0,imageList.get(position).getCalf().length);
