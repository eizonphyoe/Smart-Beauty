...
public class LumberAdapter extends BaseAdapter {
    private Context mContext;
    private List<ImageItem> imageList;

    public LumberAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getLumber(),0,imageList.get(position).getLumber().length);
