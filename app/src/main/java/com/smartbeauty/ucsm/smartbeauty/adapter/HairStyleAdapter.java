...
public class HairStyleAdapter extends BaseAdapter{
   ...
   // private ImageItem imageItem;
    ...
    public HairStyleAdapter(Context context,List<ImageItem> imageList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm= BitmapFactory.decodeByteArray(imageList.get(position).getHairStyle(),0,imageList.get(position).getHairStyle().length);
